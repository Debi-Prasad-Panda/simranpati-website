  ...
  return (
    <section className="mx-auto max-w-[1280px] px-6 py-16 md:px-16 relative">
      ...
      <div className="grid gap-8 md:grid-cols-2 relative z-10">
        ...
        <div className="bg-container-warm p-8 md:p-12 rounded-xl">
        ...
        <div className="bg-container-deep p-2 rounded-xl">
          <div className="flex h-full flex-col items-center justify-center rounded-lg bg-paper-foundation p-10 text-center border border-outline-variant/30">
            ...
            <div className="mt-8 px-6 py-3 border border-dashed border-outline-variant text-xs text-on-surface-variant rounded">
